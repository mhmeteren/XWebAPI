...
{
    public class GetAllFollowingsAsyncTests
    {



        [Fact]
        public async Task GetAllFollowingsAsync_WithInValidUsername_ThrowException()
        {
            //Arrange
            ...
            Func<Task> act = async () => await manager.GetAllFollowingsAsync(inValidUsername, It.IsAny<string>(), parameters, It.IsAny<bool>());
        ...
        [Fact]
        public async Task GetAllFollowingsAsync_WithNonExistenUsername_ThrowException()
        {
            //Arrange
            ...
            Func<Task> act = async () => await manager.GetAllFollowingsAsync(nonExistenUsername, It.IsAny<string>(), parameters, It.IsAny<bool>());
        ...
        [Fact]
        public async Task GetAllFollowingsAsync_WithInValidLoggedInUser_ThrowException()
        {
            //Arrange
            ...
            Func<Task> act = async () => await manager.GetAllFollowingsAsync(validUsername, loggedInUsername, parameters, It.IsAny<bool>());
        ...
        [Fact]
        public async Task GetAllFollowingsAsync_WithIsPrivateAccountAndIsNotFollower_ThrowException()
        {
            //Arrange
        ...
        [Fact]
        public async Task GetAllFollowingsAsync_WithIsNotPrivateAccount_ReturnFollowerDtos()
        {
            //Arrange
            ...
            mockRepositoryManager.Setup(x => x.Follows.GetAllFollowingsAsync(user.Id, parameters, It.IsAny<bool>()))
            ...
            var result = await manager.GetAllFollowingsAsync(validUsername, loggedInUsername, parameters, It.IsAny<bool>());



            //Assert

            var pagedResponse = result.Should().BeOfType<PagedResponse<FollowingDto>>().Subject;
            pagedResponse.MetaData.Should().Be(pagedList.MetaData);
            pagedResponse.Items.Should().BeEquivalentTo(mapper.Map<IEnumerable<FollowingDto>>(pagedList));
        }
